...
export const siteConfig: SiteConfig = {
  ...templateSiteConfig,
  name: "PayMate 2.0",
  description: "PayMate 2.0 documentation",
  repoUrl: "https://github.com/KrishanuGharami/paymate-docs",
  links: [
    { label: "Get started", href: "/quickstart" },
    { label: "Support", href: "https://github.com/KrishanuGharami/paymate-docs/issues/new" },
    { label: "GitHub", href: "https://github.com/KrishanuGharami/paymate-docs" },
    { label: "Changelog", href: "/changelog" },
  ],
};
